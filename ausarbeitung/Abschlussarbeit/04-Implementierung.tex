...
\item Danach wird jedem Link, das eine Entität beschreibt, die entsprechende Entitätsklasse mithilfe von den DBpedia-Daten zugeordnet.
...
\paragraph{} 
Für den Aufbau des Korpus aus deutscher Wikipedia können die Scripts von Oliver Grisel genommen werden, die allerdings angepasst werden müssen:
\begin{itemize}
...
\paragraph{}
Aber welche Vor- und Nachteile hat automatische Erzeugung vom Korpus? Kann das trainierte Modell später auch tatsächlich für sinnvolle Erkennung von Entitäten eingesetzt werden?
\begin{itemize}
\item Vorteile
\begin{itemize}
