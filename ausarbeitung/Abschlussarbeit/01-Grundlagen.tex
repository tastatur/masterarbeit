...
Zusätzlich zu manuell erstellten Korpora könnte ein Korpus auch automatisch erstellt werden, wie es z.B. für POS-Annotationen in der Arbeit von Marcus\cite{marcus1993building} gemacht wurde. In der Sektion \ref{sec:decor} des Kapitels ,,Implementierung`` wird die Erstellung eines Korpus für Entitätsextraktion auf Basis von aus Wikipedia extrahierten Daten näher beschrieben.
...
Die letzte Frage, die im Rahmen dieses Kapitels zu beantworten ist, wo genau können die für die Extraktion von Entitäten aus Suchergebnissen am besten passende Daten genommen werden.
