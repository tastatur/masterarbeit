...
\begin{enumerate}
\item Distributional Features - eine Matrix der Größe $W\timesC$, wo $W$ die Anzahl von Wörtern im Wörterbuch beschreibt und $C$ die Anzahl von verschiedenen Kontexten.
...
Ein Beispiel für Distributional Features wäre Brown-Algorithmus\cite{sun2011semi}.
