...
Aber auch wenn alle Entitäten aus dem Text extrahiert wurden, hat man das Problem, dass einige Entitäten ,,irrelevant`` sein könnten. Solche Entitäten, die dem Benutzer nicht weiter helfen können, sollen bei Möglichkeit rausgefiltert werden, damit die dem Benutzer nicht angezeigt würden. 
