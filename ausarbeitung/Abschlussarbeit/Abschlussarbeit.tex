...
{Dipl.-Inform.~Manfred Mustermann}
\thesistype{Diplomarbeit}

\logo{Bilder/logo_uni.png}
\timeperiod{Mai 2010}{November 2010}
\pagenumbering{alph}
\maketitle
...
\pagestyle{scrheadings}
\sloppy
\include{00-Einleitung}
\include{01-Grundlagen}
\include{02-Verwandte-Arbeiten}
\include{03-Konzept}
\include{04-Implementierung}
\include{05-Evaluierung}
\include{06-Fazit}
