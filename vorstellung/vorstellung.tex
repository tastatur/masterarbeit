...
\begin{document}
  ...
  \begin{frame}[c]{Beispiel}
  \begin{center}
  \includegraphics[width=0.6\linewidth]{pics/google-enchanced.png}
  \end{center}
  \end{frame}
