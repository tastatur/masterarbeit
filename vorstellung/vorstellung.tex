...
\begin{document}
  ...
  \item Beschreibung.
  \end{itemize}
  \item Diese Informationen können dem Benutzer helfen, Suchanfrage zu verfeinern.
  \end{itemize}
  \end{frame}
  ...
  \begin{center}
  \includegraphics[width=0.7\linewidth]{pics/enchancement-billgates-annotation.png}
  \end{center}
  \end{frame}
  
    \begin{frame}[c]{Entität}
  \begin{center}
  \includegraphics[width=0.7\linewidth]{pics/enchancemend-gates-extrahiert.png}
  \end{center}
  \end{frame}
